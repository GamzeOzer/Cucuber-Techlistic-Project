...
public class CommonMethods extends BaseClass {
	...
	public static void selectValueFromDD(WebElement element, String text) {
		...
		if (!isSelected) {
			System.out.println("Option with text " + text + " is notavailable");
		}
	}
	...
	public static void selectList(List<WebElement> listLocations, String text) {
...
//	public static void uploadFile(WebElement element, String uploadFilePath ) {
//		
//		
//	}

	public void radioBtnSelect(List<WebElement> radioList, String valueToSelect) {

		for (WebElement radio : radioList) {

			if (radio.isEnabled()) {
				if (radio.getAttribute("value").equalsIgnoreCase(valueToSelect)) {
					radio.click();
				}
			}
		}
	...
	public void checkBoxSelect(List<WebElement> checkList,String value) {
		for(WebElement check:checkList) {
			if(value.equalsIgnoreCase(check.getAttribute("value"))) {
				if(!check.isSelected()) {
					check.click();
				}
			}
	...
	public void checkBoxSelect(List<WebElement> checkList,String value,String value2) {
		for(WebElement check:checkList) {
			if(value.equalsIgnoreCase(check.getAttribute("value")) || value2.equalsIgnoreCase(check.getAttribute("value")) ) {
				if(!check.isSelected()) {
					check.click();
				}
			}
